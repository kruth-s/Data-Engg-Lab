...
# ------------------------------------
df_cat = spark.table("gold_ecommerce_category_sales").toPandas()
df_daily = spark.table("gold_ecommerce_daily_sales").toPandas()
...
ax1.bar(df_cat["product_category"].astype(str), df_cat["total_revenue"], color="skyblue")
...
top_category = (
    df_cat.sort_values("total_revenue", ascending=False).iloc[0]["product_category"]
...
<div style="font-family:Arial; padding:16px;">
  <h2>E-Commerce Sales Dashboard</h2>
